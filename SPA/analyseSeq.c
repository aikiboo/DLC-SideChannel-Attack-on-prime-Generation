...
int main(int argc, char const *argv[]) {
   ...
   if (mpz_divisible_p(N,ap) != 0 && mpz_cmp_ui(ap,1) != 0) { //On a trouvé p
      ...
      mpz_t aq, inv_ap, sq, bq,
            *divisorsQ,
            *congruencesQ,
            *divisorForEachCandidateQ;

      mpz_inits(aq, inv_ap, NULL, sq, bq);
      ...
      nbDivisorsQ = find_divisors(divisorsQ, congruencesQ, divisorForEachCandidateQ, sievePrimeList, nb_candidatsQ, outputQ);
      fclose(outputQ);
               ...
               if (nbMissingBitsP > bP) {
                  ...
                  if(nbMissingBitsQ > bQ) {
                     ...
                     while(mpz_divisible_p(N,q) == 0 && c <= nbNotDivisorsQ) {
                        ...
                        mpz_inits(D[0], D[1], NULL, C[0], C[1]);
                  ...
                  while(mpz_divisible_p(N,p) == 0 && c <= nbNotDivisorsP) {
                     ...
                     mpz_inits(C[0], C[1], NULL, D[0], D[1]);
