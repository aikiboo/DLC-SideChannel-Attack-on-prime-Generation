...
/*
  Fait monter le nombre de premier de la liste en entrée à k premiers.
*/
...
/*
  génère un nombre premier de k bits
*/
...
//appelle gen_k_bits_number() si la sortie est pair, ajoute 1
...
//Petmet de mettre à jour le tableau de résidus
